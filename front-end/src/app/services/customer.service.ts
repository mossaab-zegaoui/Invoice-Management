...
export class CustomerService {
    ...
    updateCustomer$(customer: Customer): Observable<CustomHttpResponse<ResponseData>> {
        return this.http.put<CustomHttpResponse<ResponseData>>(`${this.apiUrl}/${customer.id}`, customer)
            .pipe(tap(console.log), catchError(this.handleError))
    }
